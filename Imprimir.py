...
class Print:
    ...
    '''
    Imprime la fila de z
    '''
    def imprimeFilaZ(self,tabla,arregloFilas,archivo):
        aux=arregloFilas[0]+"\t"
    ...
    def imprime_Matriz(self,tabla,arregloFilas,arregloCol,archivo):
       if(len(tabla) is not 0):
          ...
          self.imprimeFilaZ(tabla,arregloFilas,archivo)
...
class Multiples_Solucion:
    ...
    '''
    Funcion en la cual se verifica si en la fila z
...
class Archivo:
    '''Encargada de crear archivo donde se 
